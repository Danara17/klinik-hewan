            ...
            <form action="{{ route('auth.register') }}" method="POST">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-3 mt-6">
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition duration-200 ease-in-out">
                            Register
                        </button>
                    </div>
                </div>
