...
@section('content')
    ...
    <div class="overflow-x-auto dark:text-white">
        <table id="myTable" class="table-auto min-w-full dark:bg-gray-800">
            <thead>
                <tr>
                    <th class="px-4 py-2">Pict</th>
                    <th class="px-4 py-2">Name</th>
                    <th class="px-4 py-2">Owner</th>
                    <th class="px-4 py-2">Pet Type</th>
                    ...
                    <tr class="dark:bg-gray-700">
                        <td class="px-4 py-2">
                            <div class="h-20 w-20 overflow-hidden">
                                <img src="{{ asset('storage/client_pets_gallery/' . $item->photo) }}"
                                    alt="foto {{ $item->name }}" class="w-full h-full object-cover">
                            </div>
                        </td>
                        <td class="">{{ $item->name }}</td>
                        <td class="">{{ $item->owner->name }}</td>
                        <td class="">{{ $item->myType->name }}</td>
                        <td class="">{{ $item->age }} tahun</td>
                        <td class="">{{ $item->weight }} Kg</td>
                        <td class="">
                            @if ($item->sex == 'male')
                                <span
