            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href=""
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">View</a>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <form action="{{ route('medical_record.store') }}" method="POST">
        ...
        <div class="mb-3">
            <div class="mb-3">
                ...
                <input type="text" id="check_date" name="check_date" value="{{ $data->check_date }}" disabled
        ...
        <div class="mb-3">
            <div class="mb-3">
                ...
                <input type="text" id="owner" name="owner" disabled value="{{ $data->pet->owner->name }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
        </div>
