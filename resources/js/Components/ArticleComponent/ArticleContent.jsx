                ...
                <div className="mx-auto w-full max-w-screen-xl p-5 py-4">
                    <div className="flex justify-between gap-24">
                        <div className="flex w-5/12 ">
                            <div className="bg-white flex flex-col w-fit border-2  gap-5 rounded-md">
                                <div>
                                    <img
                                        src={hewan}
                                        alt=""
                                ...
                                <div className="mx-3">
                                    ...
                                    <p className="text-sm">
                                        ...
                                        masyarakat Indonesia diramaikan dengan
                                        kasus wabah rabies. Di antaranya terjadi
                                        di Nusa Tenggara Timur dan Bali. Selain
                                        rabies, ternyata juga banyak penyakit
                                        dari hewan lainnya yang bisa ditularkan
                                        ke manusia.
                                    </p>
                                </div>
                                ...
                                <div className="mx-3 border-t ">
                                    ...
                                    <div className="pt-2 flex gap-3">
                                        <div className="flex gap-3">
                                            <div className="flex flex-col w-44 border-2  rounded-xl">
                            ...
                            <div className="flex flex-col gap-5 items-start w-[750px]">
                                <div className="flex flex-col border-2  rounded-lg mb-1">
                                    <div className="flex justify-start ">
                                        <img
                                            src={madrid}
                                            alt=""
                                            className="w-full h-[215px] rounded-tl-lg rounded-tr-lg"
                                        />
                                    </div>
                                    <div className="ml-1 py-1">
                                        <h1 className="text-lg font-bold mt-1">
                                            <a href="https://www.cnbcindonesia.com/research/20240509055329-128-536919/real-madrid-ke-final-liga-champions-incar-rekor-juara-ke-15">
                                                Real Madrid ke Final Liga
                                                Champions
                                            </a>
                                        </h1>
                                        <p className="mt-1">
                                            Real Madrid melaju ke final Liga
                                            Champions 2023-2024 setelah
                                            mengalahkan Bayern Muunchen 2-1 di
                                            leg II
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col border-2  rounded-lg mb-1">
                                    ...
                                    <div className="ml-1 py-1">
                                        ...
                                        <p className="mt-1">
                                            Sesuai jadwal, Timnas Indonesia akan
                                            menjamu Irak (6 Juni 2024) dan
                                            Filipina (11 Juni 2024) di dua laga
                                            pamungkas Grup F Kualifikasi Piala
