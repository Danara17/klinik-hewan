...
export default function FaqContent() {
    ...
    return (
        <div className="py-28">
            <div className="mx-auto w-full max-w-screen-xl p-10 py-8">
                <div className="flex gap-20 -[42px]">
                    <div className="border rounded-lg shadow-lg flex flex-col gap-1 p-7">
                        ...
                        {faqs.map((faq, index) => (
                            <div key={index} className={`border rounded-lg shadow-lg w-[28rem] ${index === faqs.length - 1 ? 'mb-0' : 'mb-5'}`}>
